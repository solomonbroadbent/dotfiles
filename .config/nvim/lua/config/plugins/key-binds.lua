...
require 'config/plugins/lsp/key-binds'.unset_general_key_binds()
-- require 'config-cmp/key-binds'
require 'config/plugins/treesitter/key-binds'.setup_key_bind_prompts()
require 'config/plugins/harpoon/key-binds'
require 'config/plugins/trouble/key-binds'
require 'config/plugins/telescope/key-binds'
